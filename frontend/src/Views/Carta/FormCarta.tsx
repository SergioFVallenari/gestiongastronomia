...
const FormCarta: React.FC<iFormCarta> = ({ formDisabled, accion, onSubmitSuccess, idCarta }) => {
    ...
    const handleAutocompleteChange = (event: any, selectedOptions: any) => {
        const ingredientesConCantidad = selectedOptions.map((option: any) => {
            ...
            return {
                ...option,
                cantidad: ingredienteExistente ? ingredienteExistente.cantidad : option.cantidad // Mantener cantidad previa o iniciar en 0
            };
        });
    ...
    const onSubmit = (data: any) => {
        if (accion === 'a') {
            const json_ingredientes = ingredientesSeleccionados.map((ingrediente) => (
                {
            ...
            api.post('/carta/alta_carta', body)
                .then((response) => {
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="input-group">
                                        <TextField
                                            ...
                                            disabled
                                        />
                                        <button type="button" className="btn btn-primary" onClick={calcularCosto} disabled={formDisabled}>
                                            Calcular
                                        </button>
                    ...
                    <Tab eventKey='ingredientes' title="Ingredientes">
                        <div className="col-md-12">
                            <div className="mb-3">
                                ...
                                />
                                {errors.ingredientes_json && <span className="text-danger">{errors.ingredientes_json.message}</span>}
                            </div>
                        </div>
                ...
                <div className="col-md-4">
                    <button type="submit" className="btn btn-primary" disabled={formDisabled}>Guardar</button>
                </div>
            </form>
        </>
    );
